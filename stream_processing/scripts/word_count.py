# This code is from https://nightlies.apache.org/flink/flink-docs-release-1.17/docs/dev/python/datastream_tutorial/
# for dataproc demo purposes
import argparse
import logging
import sys
...
def word_count(input_path, output_path):
    ...
    if output_path is not None:
        ds.sink_to(
            ...
            .with_rolling_policy(RollingPolicy.default_rolling_policy()) # Define when to create a new file
            .build()
        )
    else:
